...
fn remote_release_asset(asset_key: &str) -> io::Result<RemoteReleaseAsset> {
    if crate::build_info::is_preview() {
        ...
        let manifest_bytes = fetch_remote_manifest(&crate::update_source::preview_manifest_url())?;
    ...
    let manifest_bytes = fetch_remote_manifest(&crate::update_source::stable_manifest_url())?;
